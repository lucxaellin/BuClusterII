  ...
  return (
    <button
      ...
      style={{
        ...
        background:     hov ? 'var(--bg-surface2)' : 'none',
        border:         'none',
        cursor:         'pointer',
    ...
    <div style={{ position: 'relative' }}>
      <button
        ...
        style={{
          ...
          gap:          8,
          background:   hov ? 'var(--bg-surface2)' : 'none',
          border:       `1px solid ${open || hov ? 'var(--border-color)' : 'transparent'}`,
          borderRadius: RADIUS.md,
      ...
      >
        ...
        <div style={{ textAlign: 'left' }}>
          <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--text-primary)', fontFamily: FONT }}>Admin User</div>
          <div style={{ fontSize: 11, color: 'var(--text-muted)', fontFamily: FONT }}>Administrator</div>
        </div>
        <ChevronDown
          size={13}
          color={C.text3}
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ padding: '10px 14px', borderBottom: '1px solid var(--border-color)' }}>
              <div style={{ fontSize: 13, fontWeight: 600, color: 'var(--text-primary)', fontFamily: FONT }}>Admin User</div>
              <div style={{ fontSize: 11, color: 'var(--text-muted)', fontFamily: FONT, marginTop: 1 }}>admin@bicol.edu.ph</div>
            </div>
            {[
              ...
              <button
                ...
                onMouseEnter={e => e.currentTarget.style.background = danger ? 'var(--bg-danger)' : 'var(--bg-surface2)'}
    ...
    <header style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', height: '100%' }}>
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--text-primary)', fontFamily: FONT, lineHeight: 1.2 }}>Cluster II</div>
            <div style={{ fontSize: 10, color: 'var(--text-muted)', fontFamily: FONT }}>Logbook System</div>
          </div>
        </div>
      </div>
